  ...
  return (
    <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit, minmax(280px, 1fr))", gap:16, padding:"20px 0" }}>
      ...
      <div style={{ display:"flex", flexDirection:"column", gap:12 }}>
        ...
        <div style={{ background:"#fff", border:"1px solid #E2E8F0", borderRadius:12, padding:"14px 16px" }}>
          <p style={{ fontSize:11, fontWeight:700, color:C.muted, textTransform:"uppercase", letterSpacing:.7, marginBottom:8 }}>
          ...
          {penz.bevetal === 0 && <p style={{ fontSize:12, color:C.muted, fontStyle:"italic" }}>Még nincs számlázott bevétel</p>}
        </div>

        <div style={{ background:C.accentLight, border:"1px solid #BFDBFE", borderRadius:12, padding:"14px 16px" }}>
