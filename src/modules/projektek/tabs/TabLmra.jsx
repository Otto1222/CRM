...
export default function TabLmra({ projekt, munkalapok, currentUser }) {
  ...
  return (
    <div style={{ padding: "4px 0 24px" }}>
      {/* Info banner */}
      <div style={{
        background: C.dangerLight, border: `1.5px solid ${C.dangerLight}`,
        borderRadius: 12, padding: "12px 16px", marginBottom: 18,
        display: "flex", gap: 10, alignItems: "flex-start",
      }}>
        <Shield size={18} color={C.danger} style={{ flexShrink: 0, marginTop: 2 }} />
        <p style={{ margin: 0, fontSize: 13, color: C.dangerDark, lineHeight: 1.6 }}>
    ...
    <div style={{
      ...
      {open && (
        <div style={{ borderTop: `1px solid ${C.border}`, padding: "14px 16px 18px" }}>
              ...
              <>
                ...
                <button
                  ...
                  style={{
                    ...
                    border: `1px solid ${C.accentLight}`, borderRadius: 8,
                    cursor: "pointer", fontWeight: 700, fontSize: 13,
                    fontFamily: FONT, display: "flex", alignItems: "center", gap: 6,
                  }}
                >
            ...
            {canEdit && isLocked && (
              <button
                ...
                style={{
                  ...
                  border: `1px solid ${["alairva", "exportalva"].includes(status) ? C.dangerLight : "#FCD34D"}`,
          ...
          {isLocked && (
            <div style={{
              background: C.accentLight, border: `1px solid ${C.accentLight}`,
...
function KockazatRow({ kockazat, locked, canEdit, onToggle, onMegelozChange, onRemoveEgyedi }) {
  return (
    <div style={{
      ...
      border: `1.5px solid ${kockazat.kivalasztva ? C.dangerLight : C.border}`,
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 6 }}>
            <p style={{
              ...
              color: kockazat.kivalasztva ? C.dangerDark : C.textSub,
              ...
              {locked ? (
                ...
                <input
                  ...
                  style={{
                    ...
                    padding: "7px 10px", border: `1px solid ${C.dangerLight}`,
