    ...
    <div style={{ paddingTop: 14, fontFamily: FONT }}>
      ...
      {section === "osszesito" && (
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          {/* Kalkuláció részlet */}
          {kalk && (
            <div style={{ background: C.successLight, border: "1px solid #86EFAC", borderRadius: 12, padding: "14px 16px" }}>
      ...
      {section === "koltsegek" && (
        <div>
          ...
          <div style={{ marginTop: 14, background: C.dangerLight, border: "1px solid #FECACA", borderRadius: 10, padding: "10px 14px", display: "flex", justifyContent: "space-between" }}>
      ...
      {section === "statusz" && (
        <div>
          {isBelso && (
            <div style={{ background: C.successLight, border: "1px solid #86EFAC", borderRadius: 10, padding: "10px 14px", marginBottom: 14, fontSize: 13, color: "#166534", fontWeight: 600 }}>
