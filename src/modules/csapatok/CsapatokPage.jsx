...
const SZINEK = [
  C.accent, C.success, "#9333EA", "#EA580C",
  "#0891B2", C.warning, C.danger, C.textSub,
];
    ...
    <div style={{ position: "fixed", inset: 0, zIndex: 3000, background: "rgba(0,0,0,.5)", display: "flex", alignItems: "center", justifyContent: "center", padding: 16 }}>
      <div style={{ background: "#fff", borderRadius: 14, padding: 24, maxWidth: 380, width: "100%", fontFamily: FONT }}>
        ...
        <div style={{ display: "flex", gap: 10, justifyContent: "flex-end" }}>
          <button onClick={onCancel} style={{ padding: "9px 18px", borderRadius: 9, border: `1.5px solid ${C.border}`, background: "#fff", cursor: "pointer", fontWeight: 600, fontSize: 13, fontFamily: FONT }}>Mégse</button>
    ...
    <div style={{ position: "fixed", inset: 0, zIndex: 2000, display: "flex", alignItems: "flex-start", justifyContent: "center", padding: "20px 16px", overflowY: "auto" }}>
      ...
      <div style={{ position: "relative", zIndex: 1, background: "#fff", borderRadius: 16, width: "100%", maxWidth: 560, boxShadow: "0 24px 60px rgba(0,0,0,.25)", fontFamily: FONT }}>
        ...
        <div style={{ padding: "20px 24px", display: "flex", flexDirection: "column", gap: 14 }}>
          {hiba && (
            <div style={{ background: C.dangerLight, border: `1.5px solid ${C.dangerLight}`, borderRadius: 9, padding: "9px 12px", fontSize: 13, color: C.danger, fontWeight: 600 }}>{hiba}</div>
          )}
          ...
          <div>
            ...
            <input value={form.nev} onChange={e => upd("nev", e.target.value)} placeholder="pl. Budapest Csapat A" style={{ ...inp, border: `2px solid ${C.accent}`, fontWeight: 600 }} />
          </div>
              ...
              {CSAPAT_TIPUSOK.map(t => (
                <button
                  ...
                  style={{
                    ...
                    background: form.tipus === t.id ? (t.id === "sajat" ? C.accentLight : "#FFF7ED") : C.bg,
              ...
              <div style={{ display: "flex", gap: 6, flexWrap: "wrap", paddingTop: 4 }}>
                {SZINEK.map(sz => (
                  <div key={sz} onClick={() => upd("szin", sz)} style={{
                    ...
                    border: form.szin === sz ? `3px solid ${C.text}` : "2px solid transparent",
          ...
          <div style={{ borderTop: `2px solid ${C.border}`, paddingTop: 16, marginTop: 4 }}>
            ...
            {form.elszamolasAktiv && (
              <div style={{ background: C.successLight, border: `1px solid ${C.success}`, borderRadius: 10, padding: "14px 16px", display: "flex", flexDirection: "column", gap: 12 }}>
...
function CsapatTagForm({ tag, csapatId, onSave, onClose }) {
  const isNew = !tag?.id;
  const inpF = { width: "100%", boxSizing: "border-box", padding: "8px 11px", border: `1.5px solid ${C.border}`, borderRadius: 8, fontSize: 13, fontFamily: "inherit", outline: "none" };
  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 3200, background: "rgba(0,0,0,.65)", display: "flex", alignItems: "center", justifyContent: "center", padding: 16 }}>
      <div style={{ background: "#fff", borderRadius: 14, width: "100%", maxWidth: 420, padding: 22, fontFamily: FONT }}>
        ...
        {hiba && <div style={{ background: C.dangerLight, border: `1px solid ${C.dangerLight}`, borderRadius: 7, padding: "7px 10px", fontSize: 12, color: C.danger, marginBottom: 10 }}>{hiba}</div>}
        ...
        <div style={{ display: "flex", gap: 8, marginTop: 16, justifyContent: "flex-end" }}>
          <button onClick={onClose} style={{ padding: "7px 14px", border: `1.5px solid ${C.border}`, borderRadius: 7, background: "#fff", cursor: "pointer", fontFamily: FONT }}>Mégse</button>
...
function AvSavokSzerkeszto({ savok, onChange }) {
  ...
  const inpS = { width: "100%", boxSizing: "border-box", padding: "6px 8px", border: `1.5px solid ${C.border}`, borderRadius: 7, fontSize: 12, fontFamily: "inherit", outline: "none" };
  ...
  return (
    <div>
      ...
      <button onClick={addSav}
        style={{ display: "flex", alignItems: "center", gap: 4, padding: "4px 10px", border: `1.5px dashed ${C.border}`, borderRadius: 6, background: C.bg, cursor: "pointer", fontSize: 11, color: C.textSub, fontFamily: FONT, marginTop: 4 }}>
        <Plus size={10} /> Új sáv
      </button>
    </div>
  );
  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 3100, background: "rgba(0,0,0,.65)", display: "flex", alignItems: "center", justifyContent: "center", padding: 16 }}>
      <div style={{ background: "#fff", borderRadius: 14, width: "100%", maxWidth: 540, padding: 22, fontFamily: FONT, maxHeight: "90vh", overflowY: "auto" }}>
        ...
        <div style={{ background: C.successLight, border: `1px solid ${C.success}`, borderRadius: 9, padding: "10px 12px", marginTop: 12 }}>
      ...
      {szabalyok.length === 0 ? (
        ...
        szabalyok.map(sz => {
          ...
          const munkatipusNev = sz.munkatipus
            ...
            : "";
          return (
            <div key={sz.id} style={{ background: C.bg, border: `1px solid ${C.border}`, borderLeft: `3px solid ${C.accent}`, borderRadius: 8, padding: "8px 12px", marginBottom: 5, display: "flex", alignItems: "flex-start", gap: 8, opacity: sz.aktiv === false ? .6 : 1 }}>
              <div style={{ flex: 1 }}>
                <div style={{ display: "flex", gap: 6, alignItems: "center", marginBottom: 2, flexWrap: "wrap" }}>
                  <span style={{ fontWeight: 700, fontSize: 12, color: C.text }}>{munkatipusNev || "Általános"}</span>
        ...
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 12 }}>
          ...
          <div style={{ display: "flex", gap: 6, flexShrink: 0, alignItems: "center" }}>
            <button
              ...
              style={{ padding: "6px 10px", borderRadius: 8, border: `1.5px solid ${C.border}`, background: expanded ? C.accentLight : "#fff", cursor: "pointer", fontSize: 12, fontFamily: FONT, display: "flex", alignItems: "center", gap: 4, color: expanded ? C.accent : C.muted }}
            >
              Tagok & Szabályok <ChevronDown size={13} style={{ transform: expanded ? "rotate(180deg)" : "none", transition: "transform .2s" }} />
            </button>
            <button onClick={() => onEdit(csapat)} style={{ padding: "7px 12px", borderRadius: 8, border: `1.5px solid ${C.border}`, background: "#fff", cursor: "pointer", display: "flex", alignItems: "center", gap: 5, fontSize: 12, fontFamily: FONT, color: C.textSub }}>
...
export default function CsapatokPage({ currentUser }) {
  ...
  return (
    <div style={{ padding: "24px 28px", fontFamily: FONT }}>
      ...
      {csapatok.length === 0 ? (
        <div style={{ background: "#fff", borderRadius: 14, border: `1px solid ${C.border}`, padding: "60px 24px", textAlign: "center" }}>
