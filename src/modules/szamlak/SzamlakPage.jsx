    ...
    <div style={{ padding: "24px 28px", fontFamily: FONT }}>
        ...
        <div style={{ display: "flex", gap: 8 }}>
          <button
            ...
            style={{
              ...
              padding: "9px 14px", borderRadius: 9, border: `1.5px solid ${C.border}`,
      ...
      <div style={{
        ...
        <select value={statusSzuro} onChange={e => setStatusSzuro(e.target.value)} style={{
          padding: "7px 12px", borderRadius: 9, border: `1.5px solid ${C.border}`,
        ...
        <input type="date" value={from} onChange={e => setFrom(e.target.value)} style={{
          padding: "7px 10px", borderRadius: 9, border: `1.5px solid ${C.border}`, fontSize: 13, fontFamily: FONT, outline: "none",
        }} title="Kezdő dátum" />
        ...
        <div style={{ position: "relative", flex: 1, minWidth: 180 }}>
          ...
          <input value={q} onChange={e => setQ(e.target.value)}
            ...
            style={{
              ...
              border: `1.5px solid ${C.border}`, fontSize: 13, fontFamily: FONT, outline: "none",
            }} />
        </div>
                    ...
                    <tr key={s.id} style={{ borderBottom: `1px solid ${C.border}` }}>
                      ...
                      <td style={{ padding: "11px 14px" }}>
                        <div style={{ display: "flex", gap: 6 }}>
                          ...
                          >
                            <Printer size={13} color={C.textSub} />
                          </button>
                          {canEdit && (
                            <>
