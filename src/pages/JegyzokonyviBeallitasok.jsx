        ...
        <div>
          ...
          {aktivSablon && (
            <div>
              ...
              <div style={{ background:C.accentLight, border:`1px solid ${C.accentLight}`, borderRadius:10, padding:"12px 14px", marginBottom:14 }}>
                ...
                <div style={{ display:"flex", flexWrap:"wrap", gap:6 }}>
                  {VALTOZOK.map(v => (
                    <code key={v.k} style={{ background:"#fff", border:`1px solid ${C.accentLight}`, borderRadius:6, padding:"2px 8px", fontSize:12, color:C.accent, cursor:"pointer" }} title={v.l} onClick={()=>{
