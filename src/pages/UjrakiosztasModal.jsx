    ...
    <div style={{ position:"fixed", inset:0, background:"rgba(0,0,0,0.55)", zIndex:200, display:"flex", alignItems:"flex-end", justifyContent:"center", fontFamily:FONT }}>
      <div style={{ background:"#fff", borderRadius:"20px 20px 0 0", width:"100%", maxWidth:680, maxHeight:"93vh", display:"flex", flexDirection:"column" }}>
        ...
        <div style={{ flex:1, overflowY:"auto", padding:"20px 24px" }}>
          ...
          {activeTab==="kiosztás" && (
            <div>
              ...
              {Object.keys(errors).length > 0 && (
                <div style={{ background:C.dangerLight, border:`1px solid ${C.dangerLight}`, borderRadius:10, padding:"10px 14px", marginBottom:16 }}>
              ...
              {/* Figyelmeztetés */}
              <div style={{ background:C.warningLight, border:`1px solid ${C.warningLight}`, borderRadius:10, padding:"12px 14px", marginBottom:4 }}>
          ...
          {activeTab==="eredeti" && (
            <div>
              ...
              {m.megkezdesIdopont && (
                <div style={{ background:C.accentLight, borderRadius:10, padding:"12px 14px", marginTop:12, border:`1px solid ${C.accentLight}` }}>
        ...
        <div style={{ padding:"16px 24px", borderTop:`1px solid ${C.border}`, flexShrink:0 }}>
          ...
          <div style={{ width:"100%", padding:"14px", borderRadius:12, background:C.successLight, border:`1px solid ${C.success}`, textAlign:"center", fontSize:15, fontWeight:700, color:C.success }}>
            ⏳ Mentés folyamatban…
          </div>
        )}
        </div>
