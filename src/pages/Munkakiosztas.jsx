...
const KIOSZT_STATUSZOK = [
  { id: "Megkezdésre Vár",  szin: "#38BDF8", bg: C.accentLight },
...
export default function Munkakiosztas() {
  ...
  return (
    <div style={{ padding:"28px 32px", fontFamily:FONT }}>
      ...
      {/* Hibaüzenetek */}
      {hibak.length > 0 && (
        <div style={{ background:C.dangerLight, border:`1px solid ${C.dangerLight}`, borderRadius:12, padding:"12px 16px", marginBottom:20 }}>
