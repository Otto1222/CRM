...
export default function FelmeresTelepito({ m, data, onBack }) {
  ...
  return (
    <div style={{minHeight:"100vh",background:C.bg,fontFamily:FONT}}>
      ...
      {projektMegjegyzes && (
        <div style={{margin:"12px 16px 0",padding:"12px 14px",background:C.accentLight,borderRadius:12,border:`1.5px solid ${C.accentLight}`}}>
          ...
          <p style={{fontSize:13,color:C.accentHover,lineHeight:1.6,margin:0}}>{projektMegjegyzes}</p>
        </div>
      )}
      ...
      <div style={{padding:"16px 16px 160px"}}>
        ...
        <div style={{background:"#fff",borderRadius:14,border:`2px solid ${nyilatkozat?C.success:C.border}`,marginBottom:14,padding:"16px"}}>
          ...
          <p style={{fontSize:12,color:C.textSub,lineHeight:1.7,marginBottom:14}}>{NYILATKOZAT}</p>
      ...
      <div style={{
        ...
        <button onClick={handleMentes} disabled={saving}
          style={{
            ...
            background: mentve?C.success:saving?C.muted:katOkDb===7?C.accent:"#0EA5E9",
