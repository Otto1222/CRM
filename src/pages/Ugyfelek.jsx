    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 1, background: "#fff", borderRadius: 16, width: "100%", maxWidth: 560, boxShadow: "0 24px 60px rgba(0,0,0,.25)", fontFamily: FONT }}>
        ...
        <div style={{ padding: "20px 24px" }}>
          {hiba && (
            <div style={{ background: C.dangerLight, border: `1.5px solid ${C.dangerLight}`, borderRadius: 9, padding: "9px 12px", marginBottom: 14, fontSize: 13, color: C.danger, fontWeight: 600 }}>
              {hiba}
            </div>
          )}
        ...
        <div style={{ padding: "14px 24px", borderTop: `1px solid ${C.border}`, display: "flex", gap: 10, justifyContent: "flex-end" }}>
          <button onClick={onClose} style={{ padding: "9px 18px", borderRadius: 9, border: `1.5px solid ${C.border}`, background: "#fff", fontWeight: 600, fontSize: 13, cursor: "pointer", fontFamily: FONT }}>
            Mégse
          </button>
    ...
    <div style={{ position: "fixed", inset: 0, zIndex: 2100, background: "rgba(0,0,0,.6)", display: "flex", alignItems: "center", justifyContent: "center", padding: 16 }}>
      <div style={{ background: "#fff", borderRadius: 14, width: "100%", maxWidth: 400, padding: 28, fontFamily: FONT, textAlign: "center" }}>
        ...
        <div style={{ display: "flex", gap: 10 }}>
          <button onClick={onCancel} style={{ flex: 1, padding: "10px", border: `1.5px solid ${C.border}`, borderRadius: 9, background: "#fff", fontWeight: 600, fontSize: 13, cursor: "pointer", fontFamily: FONT }}>
            Mégse
          </button>
    ...
    <div style={{ padding: "24px 28px", fontFamily: FONT }}>
      ...
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 20 }}>
        ...
        <div style={{ display:"flex", gap:8 }}>
          {canPartner && (
            <button type="button" onClick={exportCsv} style={{ display:"flex", alignItems:"center", gap:6, padding:"9px 16px", background:C.bg, color:C.textSub, border:`1.5px solid ${C.border}`, borderRadius:10, cursor:"pointer", fontWeight:600, fontSize:13, fontFamily:FONT }}>
              ...
              {filtered.map((c, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Típus */}
                    <td style={{ padding: "14px 16px" }}>
                      <span style={{ background: c.type === "Vállalkozás" ? "#FEF9C3" : C.bg, color: c.type === "Vállalkozás" ? "#854D0E" : C.textSub, borderRadius: 6, padding: "3px 9px", fontSize: 11, fontWeight: 600 }}>
                        {c.type || "Magánszemély"}
                      </span>
                    </td>
                    {/* Telefon */}
                    <td style={{ padding: "14px 16px" }}>
                      {c.phone ? (
                        <a href={`tel:${c.phone}`} onClick={e => e.stopPropagation()} style={{ display: "flex", alignItems: "center", gap: 5, color: C.textSub, textDecoration: "none", fontSize: 13 }}>
                    ...
                    {/* Cím */}
                    <td style={{ padding: "14px 16px", color: C.textSub, maxWidth: 200 }}>
                      {c.address ? (
                    ...
                    <td style={{ padding: "14px 16px" }} onClick={e => e.stopPropagation()}>
                      <div style={{ display: "flex", gap: 6 }}>
                        <button
                          onClick={() => handleEdit(c)}
                          title="Szerkesztés"
                          style={{ padding: "6px 10px", background: C.bg, color: C.textSub, border: "none", borderRadius: 7, cursor: "pointer", display: "flex", alignItems: "center" }}
                        >
                          <Pencil size={13} />
                        </button>
                        <button
