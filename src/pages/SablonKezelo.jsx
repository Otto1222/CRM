...
function SablonSzerkeszto({ sablon, onSave, onClose }) {
  ...
  const tabStyle = (t) => ({
    ...
    background: aktivTab===t?"#1E3A5F":C.bg,
        ...
        <div style={{padding:"20px 24px"}}>
          ...
          {aktivTab==="fejlec" && (
            <div style={{border:`1.5px solid ${C.border}`,borderRadius:"0 8px 8px 8px",padding:20}}>
              ...
              <button onClick={()=>fejlecRef.current?.click()} style={{display:"flex",alignItems:"center",gap:8,padding:"10px 16px",background:C.accentLight,color:C.accent,border:`1.5px solid ${C.accentLight}`,borderRadius:9,cursor:"pointer",fontWeight:600,fontFamily:FONT}}>
          ...
          {aktivTab==="labléc" && (
            <div style={{border:`1.5px solid ${C.border}`,borderRadius:"0 8px 8px 8px",padding:20}}>
              ...
              <button onClick={()=>lablecRef.current?.click()} style={{display:"flex",alignItems:"center",gap:8,padding:"10px 16px",background:C.accentLight,color:C.accent,border:`1.5px solid ${C.accentLight}`,borderRadius:9,cursor:"pointer",fontWeight:600,fontFamily:FONT}}>
