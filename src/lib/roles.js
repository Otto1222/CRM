...
export const ROLE_PAGES = {
  ...
  "Admin":            ["dashboard","projektek","munkakiosztas","ugyfelek","arajanlatok","szerzodesek","naptar","karteritesek","beallitasok"],
  "Projektmenedzser": ["dashboard","projektek","munkakiosztas","ugyfelek","arajanlatok","szerzodesek","naptar","karteritesek","beallitasok"],
