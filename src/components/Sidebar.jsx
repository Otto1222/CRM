  ...
  return (
    <aside style={{
      ...
      <nav style={{ flex: 1, padding: "14px 10px", overflowY: "auto" }}>
        <p style={{ fontSize: 10, fontWeight: 700, letterSpacing: 1.5, color: "#3a5070", textTransform: "uppercase", padding: "4px 10px", marginBottom: 6 }}>
          Főmenü
        </p>
        ...
        <button onClick={() => onNav("beallitasok")} style={{
          width: "100%", display: "flex", alignItems: "center", gap: 11,
          padding: "9px 12px", borderRadius: 9, border: "none",
      ...
      <div style={{ padding: "14px 14px 20px", borderTop: `1px solid ${C.sidebarBorder}` }}>
        ...
        <button onClick={onLogout} style={{
          ...
          background: "transparent", color: "#4a6a8a", cursor: "pointer", fontSize: 13, fontFamily: FONT,
        }}>
